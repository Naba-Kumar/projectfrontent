                    ...
                    <section class="admin_approval_forms" style={clr}>
                        ...
                        <form class="modal-content">
                            ...
                            <div class="input_items" style={{ "width": "100%", "display": "flex", "justifyContent": "center", "flexDirection": "column" }}>
                                ...
                                <input type="text" placeholder="Enter subject of your complain" name="subject" required />

                                <label for="Complain">complain :</label>

                                <textarea style={{ "display": "block", "height": "200px" }} type="textarea" placeholder="Enter your complain under 250" name="complain" required />
                                {/* </div> */}
